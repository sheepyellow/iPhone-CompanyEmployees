...
- (IBAction)switchPageAddEmployee:(id)sender {
    if(self.addEmployeeViewController == nil)
    {
        AddEmployeeViewController *addEmployee = [[AddEmployeeViewController alloc] initWithNibName:@"AddEmployeeViewController" bundle:[NSBundle mainBundle]];
